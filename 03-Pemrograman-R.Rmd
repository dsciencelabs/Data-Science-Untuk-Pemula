...
Pemrograman yaitu aktivitas membuat program, yaitu menyusun sejumlah perintah yang dikenal computer. Terstruktur dapat berarti terpola, bentuk yang mengikuti aturan tertentu, juga berarti sesuatu yang sistematis. Berikut ini adalah suatu ilustrasi yang terjadi dalam algortima.

```{r pemrograman, echo=FALSE,fig.align='center',fig.cap="Proses Algoritma", out.width = '80%'}
knitr::include_graphics("images/functionmachine.gif")
```
...
Diagram berikut adalah representasi grafis dari langkah-langkah yang dilakukan dalam urutan penyajian aliran algoritma, alur kerja atau proses untuk menguntrol suatu fungsi yang menggunakan kondisi `if-else`. 

```{r if-else, echo=FALSE,fig.align='center',fig.cap="Diagaram alur if-else", out.width = '55%'}
...
Diagram berikut adalah representasi grafis dari langkah-langkah yang dilakukan dalam urutan penyajian aliran algoritma, alur kerja atau proses untuk menguntrol suatu fungsi yang menggunakan kondisi `for`. 

```{r for-loop, echo=FALSE,fig.align='center',fig.cap="Diagaram alur for", out.width = '40%'}
knitr::include_graphics("images/for-loop.jpg")
```
...
Diagram berikut adalah representasi grafis dari langkah-langkah yang dilakukan dalam urutan penyajian aliran algoritma, alur kerja atau proses untuk menguntrol suatu fungsi yang menggunakan kondisi `while`. 

```{r while-loop, echo=FALSE,fig.align='center',fig.cap="Diagaram alur while", out.width = '40%'}
...
Diagram berikut adalah representasi grafis dari langkah-langkah yang dilakukan dalam urutan penyajian aliran algoritma, alur kerja atau proses untuk menguntrol suatu fungsi yang menggunakan kondisi `break`. 

```{r break-loop, echo=FALSE,fig.align='center',fig.cap="Diagaram alur break", out.width = '40%'}
knitr::include_graphics("images/break.jpg")
```
...
```{r next-loop, echo=FALSE,fig.align='center',fig.cap="Diagaram alur next", out.width = '40%'}
knitr::include_graphics("images/next.png")
```
...
Diagram berikut adalah representasi grafis dari langkah-langkah yang dilakukan dalam urutan penyajian aliran algoritma, alur kerja atau proses untuk menguntrol suatu fungsi yang menggunakan kondisi `repeat`. 

```{r repeat-loop, echo=FALSE,fig.align='center',fig.cap="Diagaram alur repeat", out.width = '40%'}
knitr::include_graphics("images/repeat.jpg")
```
