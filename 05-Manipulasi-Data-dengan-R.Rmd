...
# 5. Manipulasi Data dengan R

Salah satu keterampilan yang paling mendasar untuk seorang Data Scientist adalah memanipulasi data. Untuk menjadi seseorang yang sangat efektif, Anda harus ahli dalam memanipulasi data penting. Hal ini perlu diperhatikan karena sebagian besar pekerjaan Anda akan melibatkan pengambilan dan pembersihan data.
...
Saya sarankan Anda untuk menginstal package `tidyverse`. Karena inti dari tidyverse mencakup packages yang cendrung Anda gunakan dalam analisis data sehari-hari.
