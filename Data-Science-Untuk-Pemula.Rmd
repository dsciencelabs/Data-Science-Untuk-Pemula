...
```{r gganimate4, echo=FALSE,fig.align='center',fig.cap="Grafik Animasi", out.width = '100%'}
knitr::include_graphics("images/suicide_animate.gif")
```
...
<!--chapter:end:10-Daftar-Pustaka.Rmd-->
